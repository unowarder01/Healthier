...
private val HealthierLightColorScheme = lightColorScheme(
    ...
    secondary = Color(0xFF5B4AEB),
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = Color(0xFFECE9FF),
    onSecondaryContainer = Color(0xFF302470),
    ...
    inversePrimary = Color(0xFF8A7CFF),
...
private val HealthierDarkColorScheme = darkColorScheme(
    ...
    secondaryContainer = Color(0xFF2C274C),
    onSecondaryContainer = Color(0xFFE5E0FF),
    ...
    inversePrimary = Color(0xFF5B4AEB),
